import { React, InputLabel, MenuItem, FormControl, Select } from 'imports';
...
export const SortingList: React.FC<SortingListProps> = ({ currentSortType, onChangeSortType }): React.ReactElement => {
  ...
  return (
    <FormControl variant="outlined">
      ...
      <Select value={currentSortType} onChange={handleChange} label="Sort by" className="sorting-list__input">
        <MenuItem value="">
          <em>None</em>
        </MenuItem>
